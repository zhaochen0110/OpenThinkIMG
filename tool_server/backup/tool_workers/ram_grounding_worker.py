...
class ModelWorker:
    def __init__(
        ...
        self.ram_server = ram_server
        self.ram_server_addr = self.get_sub_worker_addr(ram_server)
        print(f"ram_server_addr: {self.ram_server_addr}")
    ...
    def generate_stream_func(self, model, params, device):
        ...
        params.update({
            "caption": pred_dict_ram["tags"].replace(",", ".")
        })
        ...
        pred_dict_gdino.update({
            "tags": pred_dict_ram["tags"],
            "tags_chinese": pred_dict_ram["tags_chinese"],
        })
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port", type=int, default=22078)
    parser.add_argument("--worker-address", type=str, default="http://localhost:22078")
    parser.add_argument(
    ...
    parser.add_argument(
        "--ram-server", type=str, default="ram"
    )
    parser.add_argument(
        "--model-names",
        default="ram+grounding_dino",
