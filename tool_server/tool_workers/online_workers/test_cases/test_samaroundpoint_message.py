...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--image_path", type=str, default="/mnt/petrelfs/share_data/suzhaochen/new_tool/Tool-Factory/tool_server/tool_workers/online_workers/test_cases/truck_segmented.jpg"
    )
