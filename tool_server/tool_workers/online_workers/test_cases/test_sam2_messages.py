...
def main():
    ...
    image.save("/mnt/petrelfs/haoyunzhuo/mmtool/Tool-Factory/tool_server/tool_workers/restructure_worker/test_cases/truck_segmented.jpg")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-name", type=str, default='SAM2')
    ...
    parser.add_argument(
        "--image_path", type=str, default="/mnt/petrelfs/haoyunzhuo/mmtool/Tool-Factory/tool_server/tool_workers/restructure_worker/test_cases/truck.jpg"
    )
