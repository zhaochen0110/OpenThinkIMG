...
from llava_plus.constants import WORKER_HEART_BEAT_INTERVAL
from llava_plus.utils import (build_logger, server_error_msg,
    pretty_print_semaphore)
from llava_plus.model.builder import load_pretrained_model
from llava_plus.mm_utils import process_images, load_image_from_base64, tokenizer_image_token, KeywordsStoppingCriteria
from llava_plus.constants import IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
...
class ModelWorker:
    ...
    def generate_stream(self, params):
        ...
        model,processor,tokenizer = self.model,self.processor,self.processor.tokenizer
        ...
        thread = Thread(target=model.generate, kwargs=kwargs, streamer=streamer)
        thread.start()
