...
# nohup bash run_tool_grpo.sh > logs/Qwen2.5-VL-3B-grpo-chartgemma-katrina-1epoch-batch96.log &
############################
# u need to revise
export RUN_NAME="Qwen2.5-VL-3B-grpo-chartgemma-rlfromzero"
...
# model_path=/mnt/petrelfs/share_data/suzhaochen/r1/R1-V-tool/R1-V/src/output_path/Qwen2.5-VL-3B-chartgemma-1epoch-sft
