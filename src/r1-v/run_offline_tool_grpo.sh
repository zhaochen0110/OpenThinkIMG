...
# nohup bash run_tool_grpo.sh > logs/Qwen2-VL-2B-grpo-chartgemma-caogao.log &
############################
# u need to revise
export RUN_NAME="Qwen2-VL-2B-grpo-chartgemma-caogao"
...
export WANDB_DIR="/mnt/petrelfs/share_data/suzhaochen/r1/R1-V-tool/R1-V/src/r1-v/wandb/${RUN_NAME}"
...
#     wandb sync /mnt/petrelfs/share_data/suzhaochen/r1/R1-V-tool/R1-V/src/r1-v/wandb/Qwen2-VL-2B-grpo-chartgemma-caogao
# else
#     echo "No network connection, skipping upload."
# fi